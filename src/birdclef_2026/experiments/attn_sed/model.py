...
class AttnSEDModel(nn.Module):
    """HGNetV2-B0 backbone + GeM freq pooling + AttnSEDHead.
    ...
    def __init__(self, n_classes: int, dropout: float = 0.2):
        ...
        # backbone.num_features may not match actual output channels for this model
...
def build_attn_sed_model(n_classes: int, dropout: float = 0.2) -> AttnSEDModel:
    return AttnSEDModel(n_classes=n_classes, dropout=dropout)
