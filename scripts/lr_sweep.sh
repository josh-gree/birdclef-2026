...
FIXED="--total-val-rounds 10 --val-every-epochs 0.5 --soundscape-repeat 10 --dropout 0.5 --hidden 1028 --weight-decay 0.0001 --unfreeze-blocks 4 --use-augmentation --detach --batch-size 32 --force"
